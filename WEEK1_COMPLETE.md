...
*Every code block above is complete and runnable as-is — copy each into the
matching file path shown in its heading. This file documents Week 1 of the
FedMed daily-commit build; see `docs/WEEKLY_PLAN.md` for the full roadmap.*
